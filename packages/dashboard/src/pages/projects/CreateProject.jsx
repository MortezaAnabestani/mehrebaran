...
const projectSchema = yup.object().shape({
  ...
  description: yup.string().min(50, "توضیحات باید حداقل ۵۰ کاراکتر باشد").required("توضیحات پروژه اجباری است"),
    ...
    <div>
      <div className="bg-white rounded-md mb-6">
        <div className="flex items-center justify-between p-4">
          <h2 className="flex gap-3 text-xl font-medium">ایجاد پروژه جدید</h2>
      ...
      {submitSuccess && (
        <div className="bg-green-100 border border-green-400 text-green-700 px-4 py-3 rounded relative mb-4">
          ...
          <span>پروژه با موفقیت ایجاد شد. در حال انتقال...</span>
        </div>
      )}
      ...
      <form onSubmit={handleSubmit(onSubmit)}>
        <div className={`${styles.createContent_title} mb-10`}>
          ...
          <input type="text" id="title" className="px-3 py-2 text-xs rounded-md outline-0 border border-gray-300 focus:border-gray-400 h-10 w-full" placeholder="عنوان پروژه را وارد کنید" {...register("title")} />
          {errors.title && <p className="text-red-500 text-xs mt-1">{errors.title.message}</p>}
        </div>

        <div className={`${styles.createContent_title} mb-10`}>
          <label className="text-[12px] mb-2 block" htmlFor="subtitle">زیرعنوان</label>
          <input type="text" id="subtitle" className="px-3 py-2 text-xs rounded-md outline-0 border border-gray-300 focus:border-gray-400 h-10 w-full" placeholder="زیرعنوان پروژه" {...register("subtitle")} />
        ...
        <div className={`${styles.createContent_title} mb-10`}>
          ...
          <textarea rows="4" className="px-3 py-2 text-xs rounded-md outline-0 border border-gray-300 focus:border-gray-400 w-full" placeholder="خلاصه‌ای از پروژه" {...register("excerpt")} />
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-10">
          <div className="space-y-6">
            ...
            <div className={styles.createContent_title}>
              ...
              <input type="number" className="px-3 py-2 text-xs rounded-md outline-0 border border-gray-300 focus:border-gray-400 h-10 w-full" placeholder="0" {...register("targetAmount")} />
            ...
            <div className={styles.createContent_title}>
              ...
              <input type="number" className="px-3 py-2 text-xs rounded-md outline-0 border border-gray-300 focus:border-gray-400 h-10 w-full" placeholder="0" {...register("amountRaised")} />
            </div>
          </div>
          ...
          <div className="space-y-6">
            ...
            <div className={styles.createContent_title}>
              ...
              <input type="number" className="px-3 py-2 text-xs rounded-md outline-0 border border-gray-300 focus:border-gray-400 h-10 w-full" placeholder="0" {...register("targetVolunteer")} />
            ...
            <div className={styles.createContent_title}>
              ...
              <input type="number" className="px-3 py-2 text-xs rounded-md outline-0 border border-gray-300 focus:border-gray-400 h-10 w-full" placeholder="0" {...register("collectedVolunteer")} />
            </div>
          </div>
        </div>
        ...
        <div className={`${styles.createContent_title} mb-10`}>
          ...
          {!selectedDate && submitError && <p className="text-red-500 text-xs mt-1">تاریخ پایان اجباری است</p>}
        </div>

        <div className="w-full lg:w-[300px] mb-10">
          <label className="block text-xs font-medium text-gray-400 mb-2">انتخاب تصویر شاخص *</label>
          <div className="bg-slate-100 rounded-md p-2 border border-gray-400 border-dotted">
            ...
            <input type="file" accept="image/*" className="hidden" id="coverImage" {...register("coverImage")} onChange={handleCoverImageChange} />
