    ...
    <div>
      <div className="bg-white rounded-md">
        <div className="flex items-center justify-between p-4">
          <h2 className="flex gap-3 text-md lg:text-xl font-medium">ویرایش شماره</h2>
          <Link
            rel="preconnect"
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-x-8 mb-3 gap-4">
            ...
            <div className="flex flex-col gap-y-2">
              ...
              >
                ...
                {authors?.authors?.map((author, idnex) => (
                  <option key={idnex} value={author._id}>
                    {author.name}
                  </option>
                ))}
              </select>
            ...
            <div className="lg:col-start-1 lg:col-end-3">
              ...
              <div className="mt-3 flex flex-wrap gap-2 p-3 rounded-md outline-0 border border-gray-300 focus:border-gray-400">
