    ...
    <div>
      <div className="bg-white rounded-md mb-6">
        <div className="flex items-center justify-between p-4">
          <h2 className="flex gap-3 text-xl font-medium">ایجاد محتوای جدید</h2>
          <Link
            rel="preconnect"
      ...
      {submitSuccess && (
        ...
        >
          ...
          <span className="block sm:inline">مقاله با موفقیت ایجاد شد. در حال انتقال به صفحه مقالات...</span>
        </div>
      )}
