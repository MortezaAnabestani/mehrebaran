    ...
    <div className="bg-gradient-to-b from-gray-50 to-white min-h-screen">
      ...
      <div className="w-9/10 md:w-7/10 mx-auto py-12 md:py-16">
        ...
        >
          <div className="bg-white rounded-2xl shadow-sm p-8 border border-gray-100">
            <div className="flex items-start gap-4 mb-6">
              <OptimizedImage src="/icons/rules_book.svg" alt="rules icon" width={35} height={35} />
              <div>
        ...
        >
          <div className="bg-white rounded-2xl shadow-sm p-8 border border-gray-100">
            <div className="flex items-start gap-4 mb-6">
              <OptimizedImage src="/icons/requirement.svg" alt="rules icon" width={35} height={35} />
        ...
        >
          <div className="bg-white rounded-2xl shadow-sm p-8 border border-gray-100">
            <div className="flex items-start gap-4 mb-6">
              <OptimizedImage src="/icons/pull_request.svg" alt="rules icon" width={35} height={35} />
        ...
        >
          <div className="bg-white rounded-2xl shadow-sm p-8 border border-gray-100">
            <div className="flex items-start gap-4 mb-6">
              <OptimizedImage src="/icons/privacy.svg" alt="rules icon" width={35} height={35} />
        ...
        >
          <div className="flex items-start gap-4">
            <OptimizedImage src="/icons/brake_warning.svg" alt="rules icon" width={35} height={35} />
            <div>
